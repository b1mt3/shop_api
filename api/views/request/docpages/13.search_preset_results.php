<section id="section_search_preset_results" class="section">
	<br/>
	<br/>
	<h3 class="alert-success">Поиск: резултаты поиска по фильтру</h3>
	<div class="section-body">
		...
		<div class="data-item">
			<b>url:</b> <code>{baseUrl}/search/preset</code>
		...
		<div class="data-item">
			...
			<ul class="data-ul">
				...
				<li>
					<b>preset_id</b> - <i>int</i>  - <u>required</u> - ID фильтра полученный предыдушим запросом. 
				</li>
			</ul>
			<br/>
		...
		<div class="data-item">
			<b>Запрос:</b>
	<pre>
	POST {baseUrl}/search/preset       HTTP/1.1
			...
			"list": [
				{
					...
					"working_state": 1,
					"work_start_time": 0,
					"image": "http://foodexpress.spg.uz/images/restaurant/app/fc94ddefa4b9ea66e86e6e04bafa5371.jpg",
